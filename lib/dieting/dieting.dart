            ...
            child: Padding(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  width: width,
                  decoration: BoxDecoration(
                    boxShadow: const [BoxShadow(color: Colors.black87,blurRadius: 5,spreadRadius: 0.5)],
                    color: Colors.black,
                    borderRadius: BorderRadius.circular(50),
                  ),
                  child: const Text('Add To List',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25),),
                ),
              ),
            ),
          )
